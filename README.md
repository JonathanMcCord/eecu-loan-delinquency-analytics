...
The interactive Power BI dashboard turns the analysis into a tool a collections team could use day-to-day, with KPI summaries, segmentation views, member-level prioritization, and drill-through navigation to individual payment histories.

**Overview page — KPIs, loan product risk, credit tier breakdown, and monthly trend**

![EECU Loan Delinquency Dashboard Overview](visuals/dashboard_overview.png)

**Member Detail page — filterable list of flagged members with risk tier color coding**

![Member Detail page](visuals/member_detail.png)

**Member Drill-Through — individual payment history, loan breakdown, and monthly status patterns**

![Member Drill-Through page](visuals/member_drill_through.png)
